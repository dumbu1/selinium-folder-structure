...
public class ScreenShot {
	...
	public void takeScreenshotForFailTestCase(Scenario scenario) throws IOException {
		...
		File screenshot_with_scenario_name = ((TakesScreenshot)obj_DriverManager.getDriver()).getScreenshotAs(OutputType.FILE);
