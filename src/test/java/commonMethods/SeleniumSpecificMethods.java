...
public class SeleniumSpecificMethods {
	...
	//private static DriverManager obj_DriverManager=new DriverManager();
	private static HighLighter obj_HighLighter=new HighLighter();
	...
	public static void clickButton(WebElement we_button) {
		...
		obj_HighLighter.elementHighLighter(we_button);
	...
	//---------------------------------availibility of element in list----------------------------------

	public static void list_checkAvailability(WebElement element_Dropdown,List<String> expectedValues) {
		...
		for (WebElement actualElement : actualWebElements) {
		actualValues.add(actualElement.getText());
		}
		
		Assert.assertEquals(actualValues,expectedValues);
		
		LOGGER.info(expectedValues+" availibility of elements done");
	}
